...
- Sentry
- LaunchDarkly
  ![](https://storage.googleapis.com/zenn-user-upload/5f4cb087b9fe-20240227.png =700x)
...
LunchDarkly には Grafana との統合が用意されており、こちらを利用することでフィーチャーフラグの変更を Grafana ダッシュボードの注釈として表示することができます。
