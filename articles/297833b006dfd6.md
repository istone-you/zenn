...
そして、「[Effective DevOps](https://www.oreilly.co.jp/books/9784873118352/)」では**ツールの誤解**として、下記を挙げています。

> **技術*X*から、他社に合わせて技術 Y に移行しなければいけない**

文化には技術スタックが含まれており、それを全体的に変更すると組織全体の足を引っ張るようなコストがかかります。
...
<br>
本記事では様々なツールを紹介しましたが、これらのツールが正解という訳ではありませんし、これらを導入することが DevOps という訳ではありません。とはいえ、ツールは**文化**を育むために必要なものということは間違いありません。

今回の構成をそのまま真似するのではなく、現在の組織に合った適切なツールを選択して、社内の DevOps 文化を育てていきましょう！
...
何度もお伝えしますが、DevOps はツールだけでは完成しません。ツールの導入で満足するのではなく、ツールを通じて DevOps の文化を育んでいってください！
