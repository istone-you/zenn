...
[![](https://images.microcms-assets.io/assets/0402567430be43b4a7db9f7365e62718/c7b470dedf4049ffa7dccde6f7c11c5f/devops.drawio.png)](https://images.microcms-assets.io/assets/0402567430be43b4a7db9f7365e62718/c7b470dedf4049ffa7dccde6f7c11c5f/devops.drawio.png)
...
![](https://storage.googleapis.com/zenn-user-upload/dbda90f61732-20240227.png =400x)
...
今回の構成では GitHub Actions 上で Checkly CLI を動かして、**Checkly**という SaaS で E2E テストを実行します。[**Checkly**については後述します。](<#外形監視と-e2e-テスト(checkly)>)

![](https://storage.googleapis.com/zenn-user-upload/c415e7c0e7b1-20240227.png =400x)
...
![](https://storage.googleapis.com/zenn-user-upload/ae030b2756ed-20240227.png =400x)
...
![](https://storage.googleapis.com/zenn-user-upload/5f4cb087b9fe-20240227.png =800x)
...
![](https://storage.googleapis.com/zenn-user-upload/34b576f20c6c-20240227.png =500x)
...
[GitHub Actions 上で Grafana k6 CLI を動かして](<#負荷テスト(grafana-k6)>) 、Grafana Cloud の**Grafana k6**で負荷テストを実行します。
...
[GitHub Actions 上で Snyk CLI を動かして](<#セキュリティスキャン(snyk)>) 脆弱性をスキャンして、この**Snyk**にその結果を送信します。
...
単体テストや結合テストは自動化できますが、システムテストや受け入れテストは自動化できないことが多いため、テストケースの管理が必要になります。
...
外形監視とは、外部からのユーザー視点でアプリケーションの監視をすることです。Grafana Cloud にも外形監視は用意されていますが、機能としてはまだ不十分なので、**Checkly**というツールを使用します。また、[GitHub Actions 上で Checkly CLI を動かして](<#e2e-テスト(checkly%2C-playwright)>) 、この**Checkly**で E2E テストを実行します。
...
**Grafana OnCall**についての記事を今後作成予定です。

## Snyk

https://qiita.com/kannkyo/items/913055157c9105d02926

https://zenn.dev/cureapp/articles/snyk-security-101

## CodeRabbit

https://zenn.dev/minedia/articles/7928ef7545b393

https://zenn.dev/lovegraph/articles/48a3b7288299a2

## Qase

https://zenn.dev/spacemarket/articles/e5be4cd52c8387
...
https://zenn.dev/kimitsu/articles/frontend-monitoring#%E3%82%A8%E3%83%A9%E3%83%BC%E7%9B%A3%E8%A6%96

## Checkly

Checkly についての記事を今後作成予定です。
